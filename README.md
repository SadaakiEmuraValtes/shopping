...
![チェックアウト ステップ1](docs/screenshots/05_checkout_step1.png)
...
![チェックアウト ステップ2](docs/screenshots/06_checkout_step2.png)
...
| 名前 | メールアドレス | パスワード | 備考 | 好きなジャンル |
|------|-------------|----------|------|-------------|
| 田中 太郎 | tanaka@example.com | GamePass#2024 | カード限度額 ¥10,000 | RPG・アクション・アドベンチャー |
| 山田 花子 | yamada@example.com | Switch2@Love | カード限度額 ¥50,000 | マルチプレイヤー・シミュレーション・アドベンチャー |
| 佐藤 健 | sato@example.com | SoulsLiker99 | カード限度額 ¥50,000 | RPG・アクション・ホラー |
| 鈴木 美咲 | suzuki@example.com | Kawaii_Gamer! | — | シミュレーション・アドベンチャー・フィットネス |
| 高橋 雄太 | takahashi@example.com | Pro_Gamer2025 | — | アクション・ホラー・シューター（FPS/TPS）|
...
rm -rf $DEPLOY_DIR
git clone --branch gh-pages https://github.com/SadaakiEmuraValtes/shopping.git $DEPLOY_DIR 2>/dev/null \
  || (git clone https://github.com/SadaakiEmuraValtes/shopping.git $DEPLOY_DIR && cd $DEPLOY_DIR && git checkout --orphan gh-pages)
