import{_ as o,h as p,X as r,o as s,b as l,d,m as n}from"./index-14508bZZ.js";const c={class:"help-wrapper"},f={__name:"HelpView",setup(x){const e=n(null);return p(()=>{const a=e.value.attachShadow({mode:"open"}),i=r.map(t=>`
    <tr>
      <td>${t.name}</td>
      <td>${t.email}</td>
