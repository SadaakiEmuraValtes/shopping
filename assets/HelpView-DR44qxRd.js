import{_ as o,g as p,W as r,o as s,b as l,d,l as n}from"./index-GyfbFMco.js";const c={class:"help-wrapper"},f={__name:"HelpView",setup(x){const e=n(null);return p(()=>{const a=e.value.attachShadow({mode:"open"}),i=r.map(t=>`
    <tr>
      <td>${t.name}</td>
      <td>${t.email}</td>
