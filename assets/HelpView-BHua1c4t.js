import{_ as o,g as p,Z as r,o as s,b as l,d,m as n}from"./index-IFuz0r6Y.js";const c={class:"help-wrapper"},f={__name:"HelpView",setup(x){const e=n(null);return p(()=>{const a=e.value.attachShadow({mode:"open"}),i=r.map(t=>`
    <tr>
      <td>${t.name}</td>
      <td>${t.email}</td>
  ...
  `}),(a,i)=>(s(),l("div",c,[d("div",{ref_key:"shadowHost",ref:e,class:"shadow-host"},null,512)]))}},h=o(f,[["__scopeId","data-v-8debd783"]]);export{h as default};
